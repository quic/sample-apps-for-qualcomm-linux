...
ENCODER_MODEL_NAME = "whisperencoder-qcs8275"
DECODER_MODEL_NAME = "whisperdecoder-qcs8275"
...
def model_download():
    ...
    print("[INFO] IQ8 model binaries are mounted via Docker, skipping download.")
